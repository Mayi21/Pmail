-- ==========================================
-- PMail Baseline Schema (Migration 0001)
-- ==========================================
-- This is the single baseline migration for fresh D1 databases. The very
-- first `wrangler d1 migrations apply` execution runs this file end-to-end
-- to provision the entire schema.
--
-- The project is pre-launch with no backwards-compatibility burden (see
-- CLAUDE.md), so we maintain a flat baseline instead of incremental
-- migrations. Edit schema directly in `/schema.sql` and copy the contents
-- here so the two files stay byte-identical.
-- ==========================================
